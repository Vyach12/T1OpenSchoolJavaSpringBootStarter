...
public class HttpLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull final HttpServletRequest request,
        ...
        if (properties.isEnabled() && shouldLog(request.getRequestURI())) {
            ...
            String requestLog = logFormatter.createIncomingRequestLog(properties.getFormat().getIncomingRequest(), request);
            ...
            String responseLog = logFormatter.createIncomingResponseLog(properties.getFormat().getIncomingResponse(), response, durationMs);
